...
/**
 * Return the longest substring without repeating characters in s.
 * 
 * Example: s = "abcabcbb", the function should return "abc"
 * Example: s = "bbb", the function should return "b"
 * Example: s = "ututt", the function should return "ut"
 * 
